defmodule KerchingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KerchingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KerchingWeb.Gettext, "errors", msg, opts)
    end
  end
